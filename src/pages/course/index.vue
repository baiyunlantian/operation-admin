    ...
    <div class="search-container u-m-t-15 u-m-b-10">
      ...
      >
        ...
        <el-form-item class="">
          <el-button
            type="primary"
            class="btn popup-dialog-btn"
            @click="handleClickDelete('batchDel')"
            >批量删除</el-button
          >
        </el-form-item>
    ...
    <div class="u-table-main u-m-t-10 bg-fff u-flex-col">
      <div class="u-table-header-operate theme-bg title-box">
        ...
        <div class="right-sort">
          ...
          <el-select
            v-model="searchTableParams.sortType"
            class="m-2 u-m-l-10"
            placeholder="排序方式"
            @change="handleGetTableList"
          >
        ...
        >
          <template #default="{ row, column, $index }">
            <div v-if="item.insertSlot && item.prop === 'operate'">
              <span
                class="u-cursor blue u-m-r-20"
                @click="handleClickDelete('delete', row)"
                >删除</span
              >
            </div>
    ...
    >
      ...
      <template #footer>
        ...
        <el-button
          type=""
          class="btn"
          @click="handleClickDialogBtn('cancel')"
          :loading="btnLoading"
          :disabled="btnLoading"
          >取消</el-button
        >
